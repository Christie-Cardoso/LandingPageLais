        ...
        <div className="space-y-8 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button
              ...
              className="px-8 py-4 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-full shadow-[0_0_30px_rgba(16,185,129,0.3)] transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3 text-lg"
            >
            ...
            <button
              ...
              className="px-8 py-4 bg-white/10 backdrop-blur hover:bg-white/20 text-white font-bold rounded-full border border-white/20 transition-all flex items-center justify-center gap-2"
            >
