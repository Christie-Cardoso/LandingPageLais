        ...
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className="cursor-pointer flex items-center gap-2 text-sm font-bold text-white bg-emerald-600 hover:bg-emerald-700 transition-all px-6 py-2.5 rounded-full shadow-lg hover:shadow-emerald-200 hover:-translate-y-0.5"
            >
              <Calendar size={16} />
              Agendar Consulta
            </button>
          ...
          <div className="flex flex-col p-6 gap-4 text-center">
            ...
            <div className="pt-4 border-t border-stone-100">
              <button
                ...
                className="w-full cursor-pointer flex items-center justify-center gap-2 text-white bg-emerald-600 font-bold py-4 rounded-xl shadow-md"
              >
